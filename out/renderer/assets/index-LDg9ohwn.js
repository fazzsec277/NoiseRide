...
const useMp3Store = create((set, get) => ({
  ...
  removeFromPreset: (id, presetId) => {
    ...
    set((s) => ({
      presets: s.presets.map(
        (p) => p.id === presetId ? { ...p, mp3Ids: p.mp3Ids.filter((i) => i !== id) } : p
      )
    }));
  },
  ...
  setPlaying: (id, playing2) => {
    set((s) => ({
      mp3s: s.mp3s.map((m) => m.id === id ? { ...m, isPlaying: playing2 } : m)
    }));
  },
  setDuration: (id, duration2) => {
    set((s) => ({
...
function useFileDrop(targetPresetId) {
...
const useRandomStore = create((set) => ({
  ...
  setPresetActive: (presetId, active2) => set((s) => ({
    presetStates: {
      ...s.presetStates,
      [presetId]: { ...s.presetStates[presetId] ?? defaultState(), isActive: active2 }
    }
  })),
  setCurrentPlayingId: (presetId, id) => set((s) => ({
    presetStates: {
      ...s.presetStates,
      [presetId]: { ...s.presetStates[presetId] ?? defaultState(), currentPlayingId: id }
    }
  })),
  setLoadingId: (presetId, id) => set((s) => ({
    presetStates: {
      ...s.presetStates,
      [presetId]: { ...s.presetStates[presetId] ?? defaultState(), loadingId: id }
    }
  })),
  clearPreset: (presetId) => set((s) => {
...
function playNextRandom(presetId) {
...
function useLastPlayedListener() {
  const settings = useSettingsStore((s) => s.settings);
  const playLastPlayed = reactExports.useCallback(() => {
...
const header$2 = "_header_r2hcy_1";
const title = "_title_r2hcy_25";
const icon = "_icon_r2hcy_45";
const controls = "_controls_r2hcy_55";
const deviceDropdown = "_deviceDropdown_r2hcy_69";
const deviceTrigger = "_deviceTrigger_r2hcy_77";
const deviceTriggerOpen = "_deviceTriggerOpen_r2hcy_111";
const deviceLabel = "_deviceLabel_r2hcy_121";
const deviceCaret = "_deviceCaret_r2hcy_137";
const deviceMenu = "_deviceMenu_r2hcy_149";
const deviceItem = "_deviceItem_r2hcy_179";
const deviceItemLabel = "_deviceItemLabel_r2hcy_215";
const deviceControls = "_deviceControls_r2hcy_231";
const micIconWrapper = "_micIconWrapper_r2hcy_247";
const micIconMuted = "_micIconMuted_r2hcy_271";
const micIconActive = "_micIconActive_r2hcy_277";
const volumeIcon = "_volumeIcon_r2hcy_309";
const deviceSlider = "_deviceSlider_r2hcy_325";
const deviceValue = "_deviceValue_r2hcy_339";
const settingsBtn = "_settingsBtn_r2hcy_355";
const styles$8 = {
  header: header$2,
  title,
  icon,
...
function playPresetNext(presetId) {
...
function playPresetPrev(presetId) {
  const state = useRandomStore.getState();
  if (state.presetStates[presetId]?.loadingId !== null) return;
  const manager = randomRegistry.get(presetId);
...
const tabBar = "_tabBar_91teu_1";
const tabArea = "_tabArea_91teu_13";
const tabs = "_tabs_91teu_22";
const arrowBtn = "_arrowBtn_91teu_36";
const arrowDisabled = "_arrowDisabled_91teu_57";
const fadeLeft = "_fadeLeft_91teu_63";
const fadeRight = "_fadeRight_91teu_64";
const fadeVisible = "_fadeVisible_91teu_85";
const tab = "_tab_91teu_1";
const active$1 = "_active_91teu_106";
const randomOn = "_randomOn_91teu_112";
const tabTop = "_tabTop_91teu_127";
const tabBottom = "_tabBottom_91teu_136";
const tabLabel = "_tabLabel_91teu_145";
const tabSkipBtn = "_tabSkipBtn_91teu_150";
const tabRandomBtn = "_tabRandomBtn_91teu_184";
const tabInput = "_tabInput_91teu_225";
const tabClose = "_tabClose_91teu_234";
const tabCloseConfirm = "_tabCloseConfirm_91teu_253";
const addTab = "_addTab_91teu_263";
const actions = "_actions_91teu_282";
const addFileBtn = "_addFileBtn_91teu_290";
const dropTarget$1 = "_dropTarget_91teu_305";
const stopBtn = "_stopBtn_91teu_311";
const kbToggleBtn = "_kbToggleBtn_91teu_335";
const kbToggleOff = "_kbToggleOff_91teu_357";
const styles$7 = {
  tabBar,
  tabArea,
  tabs,
...
function TabBar() {
  ...
  const handlePresetDblClick = (id, name) => {
    if (id === GLOBAL_PRESET_ID) return;
    setEditingPreset(id);
    setEditName(name);
  ...
  const handleAddFiles = async () => {
    ...
    const target = activePresetId === GLOBAL_PRESET_ID ? void 0 : activePresetId;
  ...
  const toggleRandom = reactExports.useCallback((presetId) => {
    const state = useRandomStore.getState();
    ...
    if (isActive) {
      ...
      const allIds = presetId === GLOBAL_PRESET_ID ? mp3s.map((m) => m.id) : preset?.mp3Ids ?? [];
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              className: [
                ...
                isRandom ? styles$7.randomOn : "",
                dropPresetIdx === idx ? styles$7.dropTarget : ""
              ].join(" "),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.tabTop, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.tabBottom, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      className: styles$7.tabSkipBtn,
                      onClick: (e) => {
                        e.stopPropagation();
                        playPresetPrev(p.id);
                      },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      className: styles$7.tabRandomBtn,
                      onClick: (e) => {
                        e.stopPropagation();
                        toggleRandom(p.id);
                      },
...
const displayWrapper = "_displayWrapper_1x5u8_1";
const nameText = "_nameText_1x5u8_8";
const input = "_input_1x5u8_17";
const styles$6 = {
  displayWrapper,
  nameText,
  input
};
function Mp3NameEditor({ name, onSave }) {
  const [editing, setEditing] = reactExports.useState(false);
  const [draft, setDraft] = reactExports.useState(name);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.displayWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      className: styles$6.nameText,
      title: name,
      onDoubleClick: (e) => {
        e.stopPropagation();
        setEditing(true);
...
function displayKey(k) {
  return k.replace("Return", "Enter").replace(/^num(\d)$/, "Num$1").replace("numdec", "Num.").replace("numadd", "Num+").replace("numsub", "Num-").replace("nummult", "Num*").replace("numdiv", "Num/");
}
function KeybindEditor({ mp3 }) {
  const updateKeybinds = useMp3Store((s) => s.updateKeybinds);
  const allMp3s = useMp3Store((s) => s.mp3s);
  const [capturing2, setCapturing] = reactExports.useState(false);
  const duplicates = mp3.keybinds.filter(
...
function Mp3ItemRow({ mp3, onHandlePointerDown }) {
  ...
  const settings = useSettingsStore((s) => s.settings);
  const isRandomPlaying = useRandomStore(
    (s) => Object.values(s.presetStates).some((ps) => ps.currentPlayingId === mp3.id)
  );
  const isRandomLoading = useRandomStore(
    (s) => Object.values(s.presetStates).some((ps) => ps.loadingId === mp3.id)
  );
...
function Mp3List({ mp3s, activePresetId }) {
  ...
  const handleRandomQueueColumnClick = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.container, children: mp3s.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.empty, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "MP3ファイルをドラッグ&ドロップするか、「+ 追加」ボタンで追加してください" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.list, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.header, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: `${styles$2.colActions} ${isRandomActive ? styles$2.colSortable : styles$2.colRandomSortDisabled} ${sortField === "randomQueue" ? styles$2.colSortActive : ""}`,
...
const header = "_header_kigzj_20";
const closeBtn = "_closeBtn_kigzj_30";
const body = "_body_kigzj_40";
const field = "_field_kigzj_47";
const label$1 = "_label_kigzj_53";
const numberRow = "_numberRow_kigzj_66";
const numBtn = "_numBtn_kigzj_72";
const numValue = "_numValue_kigzj_92";
const themeRow = "_themeRow_kigzj_106";
const themeBtn = "_themeBtn_kigzj_111";
const active = "_active_kigzj_127";
const shortcutSection = "_shortcutSection_kigzj_134";
const shortcutLabel = "_shortcutLabel_kigzj_142";
const shortcutRow = "_shortcutRow_kigzj_150";
const shortcutName = "_shortcutName_kigzj_157";
const keyGroup$1 = "_keyGroup_kigzj_163";
const keyBadge$1 = "_keyBadge_kigzj_169";
const clearBtn$1 = "_clearBtn_kigzj_180";
const recordBtn$1 = "_recordBtn_kigzj_196";
const recordBtnActive$1 = "_recordBtnActive_kigzj_212";
const dangerZone = "_dangerZone_kigzj_224";
const dangerLabel = "_dangerLabel_kigzj_232";
const dangerRow = "_dangerRow_kigzj_240";
const dangerDesc = "_dangerDesc_kigzj_247";
const dangerBtn = "_dangerBtn_kigzj_252";
const confirmRow = "_confirmRow_kigzj_268";
const confirmYes = "_confirmYes_kigzj_274";
const confirmNo = "_confirmNo_kigzj_288";
const versionSection = "_versionSection_kigzj_302";
const styles$1 = {
  overlay,
  modal,
  header,
...
function SettingsModal({ settings, onUpdate, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.overlay, onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.modal, onClick: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.body, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.shortcutSection, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.shortcutLabel, children: "再生ショートカット" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.shortcutRow, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.shortcutName, children: "最後に再生した曲" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.keyGroup, children: [
            settings.lastPlayedBind && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.keyBadge, children: settings.lastPlayedBind }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$1.clearBtn, onClick: () => clearBind("lastPlayed"), title: "クリア", children: "×" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                className: `${styles$1.recordBtn} ${recording === "lastPlayed" ? styles$1.recordBtnActive : ""}`,
                onClick: () => setRecording((r) => r === "lastPlayed" ? null : "lastPlayed"),
                children: recording === "lastPlayed" ? "キー入力待ち..." : settings.lastPlayedBind ? "変更" : "キーを記録"
              }
            )
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.versionSection, children: [
        "v",
        appVersion
      ] })
    ] })
